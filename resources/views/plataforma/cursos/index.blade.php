...
<div class="">
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
      <h1 class="text-4xl font-bold tracking-tight ">Recien agregados</h1>
    ...
    <section aria-labelledby="products-heading" class="pt-6 pb-24">
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
        ...
        <form class="hidden lg:block">
          <h3 class="font-bold text-2xl mt-3">Categorias</h3>
          <ul role="list" class="space-y-4 border-b border-gray-500 pb-6 text-sm font-medium ">
            @foreach ($categorias as $categoria )              
            <li class="hover:bg-nav-700 p-3 rounded-md">
              <a href="#">{{ $categoria->nombre_categoria }}</a>
            </li>
            @endforeach           
          </ul>
          <h3 class="font-bold text-2xl my-3">Especialidades</h3>
          <ul role="list" class="space-y-4 border-b border-gray-500 pb-6 text-sm font-medium ">
            @foreach ($especialidades as $especialidad )              
            <li class="hover:bg-nav-700 p-3 rounded-md">
              <a href="#">{{ $especialidad->nombre }}</a>
            </li>
            @endforeach           
          </ul>
        </form>
