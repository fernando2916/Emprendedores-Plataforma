        ...
        <table class="w-full text-sm text-left">
          ...
          <tbody>
            ...
            <tr class="border-b dark:border-gray-700 ">
              <th scope="row" class="px-4 py-3 font-medium whitespace-nowrap dark:text-white">{{ $categoria->id
                }}</th>
              <td class="px-4 py-3">{{ $categoria->nombre }}</td>              
              <td class="px-4 py-3 flex items-center justify-end">
                <div class="flex items-center gap-2">
                  <a href="{{ route('admin.categories.edit', $categoria) }}" wire:navigate>
                  ...
                  <form class="delete-form" action="{{ route('admin.categories.destroy', $categoria) }}" method="POST">
                    @csrf
                    @method('DELETE')
