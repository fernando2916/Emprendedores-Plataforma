...
<div class="w-full flex justify-between items-center max-w-screen-xl mx-auto">
  ...
  <a href="{{ route('admin.categorias.create') }}" wire:navigate>
    <button
            ...
            <tr class="border-b dark:border-gray-700 ">
              ...
              <td class="px-4 py-3 flex items-center justify-start">
                <div class="flex items-center gap-2">                 
                  @can('categoria curso edit')

                  <a href="{{ route('admin.categorias.edit', $categoria) }}" wire:navigate>
                    <button
