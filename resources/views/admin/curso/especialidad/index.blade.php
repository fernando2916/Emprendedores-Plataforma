...
<div class="w-full flex justify-between items-center max-w-screen-xl mx-auto">
  ...
  @can('categoria curso create')

  <a href="{{ route('admin.especialidad.create') }}" wire:navigate>
    <button
...
<section class="pt-3">
  <div class="mx-auto max-w-screen-xl">
    ...
    <div class="bg-light-200 dark:bg-cont-100 relative shadow-md rounded-lg overflow-hidden">
            ...
            <tr class="border-b dark:border-gray-700 ">
              ...
              <td class="px-4 py-3 flex items-center justify-start">
                <div class="flex items-center gap-2">                 
                  @can('especialidad curso edit')

                  <a href="{{ route('admin.especialidad.edit', $especialidad) }}" wire:navigate>
                    <button
                  ...
                  @endcan
                  @can('especialidad curso delete')

                  <form class="delete-form" action="{{ route('admin.especialidad.destroy', $especialidad) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                      class="px-3 py-2 bg-btn-200 hover:bg-btn-400 dark:bg-btn-400 dark:hover:bg-btn-600 transition-colors duration-150 rounded-md cursor-pointer">
      ...
      <div class="m-5">
           {{ $especialidades->links('vendor.pagination.tailwind') }}
        </div>
    </div>
  </div>
</section>
