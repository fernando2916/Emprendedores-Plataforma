        ...
        <div class="">
          ...
          @enderror">
                ...
                <div>
                    ...
                    <input id="name" name="mensaje" value="{{ old('mensaje') }}" type="text" placeholder="Mensaje del aviso" class="disabled:bg-nav-900 disabled:border-nav-900 border-link-100 focus:shadow-link-200 w-full rounded-md border-2 bg-transparent p-2 outline-none focus:shadow-md placeholder:text-slate-900 dark:placeholder:text-slate-400 mt-2 @error('mensaje')
          dark:border-alerts-500
          @enderror">
                    @error('mensaje')
                ...
                <div>
                    ...
                    <input id="name" name="expira_en" value="{{ old('expira_en') }}" type="datetime-local" placeholder="Expira en" class="disabled:bg-nav-900 disabled:border-nav-900 border-link-100 focus:shadow-link-200 w-full rounded-md border-2 bg-transparent p-2 outline-none focus:shadow-md placeholder:text-slate-900 dark:placeholder:text-slate-400 mt-2 @error('expira_en')
          dark:border-alerts-500
          @enderror">
                    @error('expira_en')
